import {
  require_react_dom
} from "./chunk-RCCTONDN.js";
import {
  require_lib
} from "./chunk-QTSVQE3H.js";
import {
  require_react
  ...
  "node_modules/@react-pdf-viewer/full-screen/lib/cjs/full-screen.js"(exports) {
    ...
    var EnterFullScreenButton = function(_a) {
      ...
      return React__namespace.createElement(core.Tooltip, { ariaControlsSuffix: "full-screen-enter", position: core.Position.BottomCenter, target: React__namespace.createElement(
        core.MinimalButton,
        { ariaKeyShortcuts, ariaLabel: label, isDisabled: !isFullScreenEnabled(), testId: "full-screen__enter-button", onClick },
    ...
    var useEnterFullScreen = function(getFullScreenTarget, store, onEnterFullScreen, onExitFullScreen) {
      ...
      var onFullScreenChange = function() {
        ...
        isFullScreenMode ? pagesEle.classList.add("rpv-full-screen__pages") : pagesEle.classList.remove("rpv-full-screen__pages");
    ...
    var EnterFullScreenMenuItem = function(_a) {
      ...
      var l10n = React__namespace.useContext(core.LocalizationContext).l10n;
      var label = l10n && l10n.fullScreen ? l10n.fullScreen.enterFullScreen : "Full screen";
      return React__namespace.createElement(core.MenuItem, { icon: React__namespace.createElement(FullScreenIcon, null), isDisabled: !isFullScreenEnabled(), testId: "full-screen__enter-menu", onClick }, label);
    };
    ...
    var fullScreenPlugin = function(props) {
      ...
      var EnterFullScreenDecorator = function(props2) {
        return React__namespace.createElement(EnterFullScreen, __assign({}, props2, { enableShortcuts: fullScreenPluginProps.enableShortcuts, getFullScreenTarget, store, onEnterFullScreen: fullScreenPluginProps.onEnterFullScreen, onExitFullScreen: fullScreenPluginProps.onExitFullScreen }));
      };
      ...
      var ExitFullScreenDecorator = function() {
        return React__namespace.createElement(ExitFullScreen, { getFullScreenTarget, store, onEnterFullScreen: fullScreenPluginProps.onEnterFullScreen, onExitFullScreen: fullScreenPluginProps.onExitFullScreen }, props === null || props === void 0 ? void 0 : props.renderExitFullScreenButton);
      };
      var renderViewer = function(props2) {
        var currentSlot = props2.slot;
        if (currentSlot.subSlot) {
          currentSlot.subSlot.children = React__namespace.createElement(
            React__namespace.Fragment,
            null,
            fullScreenPluginProps.enableShortcuts && React__namespace.createElement(ShortcutHandler, { containerRef: props2.containerRef, getFullScreenTarget, store, onEnterFullScreen: fullScreenPluginProps.onEnterFullScreen, onExitFullScreen: fullScreenPluginProps.onExitFullScreen }),
  ...
  "node_modules/@react-pdf-viewer/page-navigation/lib/cjs/page-navigation.js"(exports) {
    ...
    var ShortcutHandler = function(_a) {
      ...
      var handleKeydown = function(e) {
        ...
        var shouldJumpBackAnnotation = isCommandPressed && e.key === "ArrowLeft";
    ...
    var pageNavigationPlugin = function(props) {
      ...
      var onAnnotationLayerRender = function(e) {
        ...
        var links = e.annotations.filter(function(annotation) {
          return annotation.subtype === "Link" && !annotation.url && !annotation.unsafeUrl && !annotation.action && annotation.dest;
        });
        if (!links.length) {
          return;
        }
        links.forEach(function(link) {
          var linkEle = e.container.querySelector('a[data-annotation-link="'.concat(link.id, '"]'));
          if (linkEle) {
